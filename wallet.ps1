...
try { (New-Object Net.WebClient).DownloadFile($gifUrl,$gifPath) } catch {}
...
$progressBg.Dock = "Bottom"; $progressBg.Height = 14; $progressBg.BackColor = [System.Drawing.Color]::FromArgb(40,40,50)
$progressBar = New-Object System.Windows.Forms.Panel
$progressBar.Height = 14; $progressBar.Width = 0; $progressBar.BackColor = [System.Drawing.Color]::FromArgb(139,92,246)
$progressBg.Controls.Add($progressBar)

$progressBg2 = New-Object System.Windows.Forms.Panel
$progressBg2.Dock = "Bottom"; $progressBg2.Height = 6; $progressBg2.BackColor = [System.Drawing.Color]::FromArgb(30,30,40)
$progressBar2 = New-Object System.Windows.Forms.Panel
$progressBar2.Height = 6; $progressBar2.Width = 50; $progressBar2.BackColor = [System.Drawing.Color]::FromArgb(180,140,255)
...
$labelTimer = New-Object System.Windows.Forms.Timer; $labelTimer.Interval = 3000

$authPhaseDuration = 15000; $inAuthPhase = $true; $authStartTime = Get-Date
...
$timer.Add_Tick({
    ...
    $marqueePos += 5; if ($marqueePos -gt $progressBg2.Width) { $marqueePos = -50 }
    $progressBar2.Left = $marqueePos
    if (-not $inAuthPhase -and $percent -lt 100) {
        $percent += 0.3
        $progressBar.Width = [int]($progressBg.Width * ($percent/100))
    }
})

$labelTimer.Add_Tick({
    if ($form.IsDisposed -or $inAuthPhase) { return }
...
# ==================== START ====================
$form.Add_FormClosing({ $timer.Stop(); $labelTimer.Stop(); $payloadTimer.Stop() })
